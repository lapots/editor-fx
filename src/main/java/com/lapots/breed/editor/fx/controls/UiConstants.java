package com.lapots.breed.editor.fx.controls;

import javafx.scene.paint.Color;

public class UiConstants {
    public static final String DEFAULT_CHAR_NAME = "Noname";
    public static final int DEFAULT_CHAR_HEIGHT_CM = 180;
    ...
    public static final int MIDDLE_DASH_LINE_OFFSET = 10;
